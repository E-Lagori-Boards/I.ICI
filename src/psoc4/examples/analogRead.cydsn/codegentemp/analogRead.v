// ======================================================================
// analogRead.v generated from TopDesign.cysch
// 02/07/2024 at 17:52
...
module ADC_SAR_SEQ_P4_v2_60_0 (
	...
	cy_clock_v1_0
		#(.id("20842182-0db9-44ec-a6f9-d8c642fbf810/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("117647058.823529"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
module SCB_P4_v4_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("8c8734ef-3644-4eed-bc55-360072b94fff/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8c8734ef-3644-4eed-bc55-360072b94fff/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__ADC_Pin_net;
	wire [0:0] tmpFB_0__ADC_Pin_net;
	wire [0:0] tmpIO_0__ADC_Pin_net;
	wire [0:0] tmpINTERRUPT_0__ADC_Pin_net;
	electrical [0:0] tmpSIOVREF__ADC_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_Pin
		 (.oe(tmpOE__ADC_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_Pin_net[0:0]}),
		  .analog({Net_113}),
		  .io({tmpIO_0__ADC_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_Pin_net),
		  .interrupt({tmpINTERRUPT_0__ADC_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("71e97609-be2c-4911-9001-684f2acd9ad4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d179742d-952c-43a7-bfdb-cf6363138d3a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3e58c0f9-7f81-476a-a95f-71198c07a8a0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__CTRL_net;
	wire [0:0] tmpFB_0__CTRL_net;
	wire [0:0] tmpIO_0__CTRL_net;
	wire [0:0] tmpINTERRUPT_0__CTRL_net;
	electrical [0:0] tmpSIOVREF__CTRL_net;
	...
	cy_psoc3_pins_v1_10
		...
		CTRL
		 (.oe(tmpOE__CTRL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CTRL_net[0:0]}),
		  .io({tmpIO_0__CTRL_net[0:0]}),
		  .siovref(tmpSIOVREF__CTRL_net),
		  .interrupt({tmpINTERRUPT_0__CTRL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CTRL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
